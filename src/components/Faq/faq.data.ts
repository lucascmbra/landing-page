...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Cada curso tem seus pré-requisitos descritos na própria página. Identifique-os para obter um melhor aproveitamento do seu SHIFT.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Não. Os materiais utilizados em sala de aula são fornecidos pela FIAP, e as aulas mais técnicas são realizadas em nossos próprios laboratórios. Sugerimos apenas que você leve o que preferir para suas anotações.",
  },
  {
